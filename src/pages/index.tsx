  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Empower your team with HR Management System - Simplifying employee data, vacations, time tracking, payrolls, and performance evaluations in one central place."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Empower your team with HR Management System - Simplifying employee data, vacations, time tracking, payrolls, and performance evaluations in one central place.`}
            </Text>
            <Box
